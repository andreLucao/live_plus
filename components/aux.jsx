...
const navigationItems = [
  {
    ...
    label: "Financeiro",
    subItems: [
      { icon: <LayoutDashboard size={20} />, label: "Dashboard", path: "/financeiro" },
      { icon: <FileText size={20} />, label: "Despesas", path: "/despesas" },
      { icon: <PiggyBank size={20} />, label: "Receitas", path: "/receitas" }
    ]
  },
  {
    ...
    subItems: [
      ...
      { icon: <Stethoscope size={20} />, label: "Gestão de Procedimentos", path: "/procedures" }
    ]
  },
  {
